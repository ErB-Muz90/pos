...
const InvoiceDetailView: React.FC<InvoiceDetailViewProps> = ({ invoice, supplier, purchaseOrder, settings, onBack }) => {
    ...
    const EmailIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" /><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" /></svg>;
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-2">
                        <motion.button 
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="bg-secondary text-white font-bold px-3 py-2 rounded-lg hover:bg-sky-600 transition-colors shadow-sm flex items-center text-sm"
                        >
                           <EmailIcon/> Email Invoice
                        </motion.button>
                         <motion.button 
